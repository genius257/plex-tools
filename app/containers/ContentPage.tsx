        ...
        <div data-tid="container" className={[styles.container].join(' ')}>
          <div className={styles.sidebar}>
            <div className={styles.sidebarLink}>
              <NavLink className={styles.sourceLink} exact activeClassName={styles.active} to={routes.CONTENT_HOME}>
                <div className={styles.iconContainer}><i className="fa fa-home" /></div>
                <div>Home</div>
              </NavLink>
            </div>
            <div className={styles.sidebarLink}>
              <NavLink className={styles.sourceLink} activeClassName={styles.active} to={routes.CONTENT_SHARE}>
                <div className={styles.iconContainer}><i className="fa fa-share-alt" /></div>
                <div>Share</div>
              </NavLink>
            </div>
            <div className={styles.sidebarLink}>
              <NavLink className={styles.sourceLink} activeClassName={styles.active} to={routes.CONTENT_MISSING}>
                <div className={styles.iconContainer}><i className="fa fa-question" /></div>
                <div>Missing</div>
              </NavLink>
            </div>
          </div>
